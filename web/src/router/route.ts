...
export const dynamicRoutes: Array<RouteRecordRaw> = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path: '/app/appmgr',
                        name: 'appmgr',
                        component: ()=>import('/@/views/deploy/app/app_mgr.vue'),
                        meta: {
                            title: '应用管理',
                            isLink: '',
                            isHide: false,
                        ...
                        path: '/app/appcomp',
                        name: 'appcomp',
                        component: ()=>import('/@/views/deploy/app_component/index.vue'),
                        meta: {
                            title: '应用组件管理',
                            isLink: '',
                            isHide: false,
                        ...
                        path: '/app/appcomp/edit',
                        name: 'appcomp_edit',
                        component: () => import('/@/views/deploy/app_component/app_comp_info.vue'),
                        meta: {
                            title: '应用组件编辑',
                            isLink: '',
                            isHide: true,
                        ...
                        path: '/app/appcomp/conf',
                        name: 'appcomp_conf',
                        component: () => import('/@/views/deploy/app_component/app_comp_conf.vue'),
                        meta: {
                            title: '应用组件变量配置',
                            isLink: '',
                            isHide: true,
                        ...
                        path: '/app/appcomp/deploy',
                        name: 'appcomp_deploy',
                        component: () => import('/@/views/deploy/app_component/app_comp_deploy.vue'),
                        meta: {
                            title: '应用组件部署',
                            isLink: '',
                            isHide: true,
                        ...
                        path: '/app/appcomp/k8sconf',
                        name: 'appcomp_k8sconf',
                        component: () => import('/@/views/deploy/app_component/app_k8s_conf_edit.vue'),
                        meta: {
                            title: '应用组件编排',
                            isLink: '',
                            isHide: true,
                        ...
                        path: '/app/appinfo',
                        name: 'appinfo',
                        component: () => import('/@/views/deploy/app/app_info.vue'),
                        meta: {
                            title: '应用编排',
                            isLink: '',
                            isHide: true,
                        ...
                        path: '/app/appdeploy',
                        name: 'app_deploy',
                        component: () => import('/@/views/deploy/app_deploy/index.vue'),
                        meta: {
                            title: '应用组件发布',
                            isLink: '',
                            isHide: false,
                        ...
                        path: '/app/appdeploy/view',
                        name: 'app_deploy_task_view',
                        component: () => import('/@/views/deploy/app_deploy/app_deploy_task_info.vue'),
                        meta: {
                            title: '应用发布任务详情',
                            isLink: '',
                            isHide: true,
                ...
                path: '/environment',
                name: 'appenv',
                component: () => import('/@/views/deploy/environment/environment_mgr.vue'),
                meta: {
                    title: '环境管理',
                    isLink: '',
                    isHide: false,
                ...
                path: '/app_grey_deploy',
                name: 'app_grey_deploy',
                component: ()=> import('/@/views/deploy/app_grey_deploy/index.vue'),
                meta: {
                    title: '应用灰度发布',
                    isLink: '',
                    isHide: false,
                ...
                path: '/app_grey_deploy/normal_edit',
                name: 'app_grey_deploy_normal_edit',
                component: ()=> import('/@/views/deploy/app_grey_deploy/app_comp_deploy_edit.vue'),
                meta: {
                    title: '应用灰度组件编排',
                    isLink: '',
                    isHide: false,
